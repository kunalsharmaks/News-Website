...
<div class="news">
              ...
              <?php
               ...
               on post.author=user.user_id where author={$aid};";
               $result=mysqli_query($conn,$sql) or die("Query Failed");
               $row1=mysqli_fetch_assoc($result);
               ?>
                         <h2><?php echo  strtoupper($row1["username"]);?></h2>
                         <hr />
                         <?php
                      include "config.php";
                      $limit=3;
                      ...
                      ?>
                         ...
                         echo '<ul>';
                         if($page_no>1){
                         echo '<li><a href="author.php?aid='.$aid.'&page='.($page_no-1).'">Prev</a></li>';
                         }
                         ...
                         echo '<li><a href="author.php?aid='.$aid.'&page='.($page_no + 1).'">Next</a></li>';
                         }
                         echo '</ul>';
                         echo '</div>';
                        }
